...
- 29/11/2025: Correção crítica para frames trancados (exportados como imagem única) e upload de imagens (respeitando checkbox); suporte NO-AI ajustado; UI readonly (ambos textareas de saída).
